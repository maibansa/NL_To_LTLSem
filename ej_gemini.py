...
client = genai.Client(api_key="AIzaSyCUZkeRhB7NnYBVUUwDoHHbcm5pkFBfGgY")

# El prompt que proporcionaste
clinical_prompt = """
...
# Llamada al último modelo: gemini-3.1-pro
response = client.models.generate_content(
    model="gemini-2.5-flash",
    contents=clinical_prompt,
    config=types.GenerateContentConfig(
        # Forzamos a que la salida sea un JSON válido
        response_mime_type="application/json",
        temperature=0.1, # Baja temperatura para mayor precisión lógica
    ),
)
